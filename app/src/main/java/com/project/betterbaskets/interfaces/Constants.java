package com.project.betterbaskets.interfaces;
...
public interface Constants {
    ...
    public static final String CHILD_CAT_ID = "ChildCatId";
    ...
    public static final String PURCHASED_TAG = "purchase";
    ...
    public static final String BOOKING_STATUS_NEW = "new";
